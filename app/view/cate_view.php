<div  id="wrap">
  <div id="content">
    <?php if ( $posts === FALSE ) : ?>
    <div class="entry">
      <h2><a href="javascript:void(0);">还没更新...</a></h2>
      <div class="postmeta"><?php echo date('Y月m月j日H:i:s', time());?></div>
      <div class="post">
        请耐心等待...
      </div>
    </div>
    ...
    <div class="entry">
      ...
      <div class="postmeta"><span class="postcategory">分类:<?php echo get_cate_link($post->category_name, $post->category_slug);?></span><span class="posttime"><?php echo convert_time($post->post_time); ?></span><span class="postcmt"><?php echo get_comment_link($post->post_title, $post->post_id, $post->post_comment_count); ?></span><span class="postview"><?php echo $post->post_hit; ?></span></div>
